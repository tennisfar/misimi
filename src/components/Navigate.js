export function initNavigation(g) {
  //  Input Events
  ...
  g.btnLeft.on('pointerdown', () => g.movingLeft = true);
  g.btnLeft.on('pointerup', () => g.movingLeft = false);

  g.btnRight.on('pointerdown', () => g.movingRight = true);
  g.btnRight.on('pointerup', () => g.movingRight = false);

  g.btnDown.on('pointerdown', () => g.movingUp = true);
  g.btnDown.on('pointerup', () => g.movingUp = false);
